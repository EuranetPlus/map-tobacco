export const config = {
	mapTitle: 'tobacco', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-tobacco.vercel.app/', // The url provided when deploying the map on Vercel
